        ...
        <ThemedCard>
            ...
            <SectionList sections={houses}
                         ...
                         renderSectionHeader={({section})=> (
                             <ThemedText type = "h1" className="bg-light-background dark:bg-dark-background p-2 rounded font-semibold mb-3">
                                 {section.title}
                             </ThemedText>
                         )}
                         ...
                         ListFooterComponent = {()=>(
                             <ThemedText type = "h1"
                                 className="font-bold bg-light-background dark:bg-dark-background p-2 rounded font-semibold mb-10">
